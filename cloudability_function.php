<?php
function cloudability_function() {
...
$start_date = $last_month."-16";

$this_month = date("Y-m");
$end_date = $this_month."-15";
...
require_once('splunk_function.php');
...
#foreach ($grouped_clients as $region=>$clients) {
	#foreach ($clients as $client=>$data) {
		#print "$region :: $client :: " . $data['sum_of_weight_perc'] . "\n";
	#}
#}
